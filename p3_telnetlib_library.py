...
class p3_telnetlib_library:
    def __init__(self, network_device_ip, network_device_port, network_device_username, network_device_password, network_device_enable_password):
...
def main():
    telnet_client_instance = p3_telnetlib_library('10.254.13.1', 23, 'adm1n', '', '');
